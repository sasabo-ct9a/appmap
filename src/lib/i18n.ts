...
const JA: Translations = {
  ...
  inspector: {
    panelAriaLabel: "要素の詳細パネル",
    closeAriaLabel: "閉じる",
    entryPointHint: "この要素から理解するとアプリ全体が掴みやすいです",
    descriptionLabel: "説明",
    relatedLabel: "リンク先",
    filesLabel: "対応ファイル",
    dataLabel: "使うデータ",
  ...
  specDoc: {
    ...
    modalTitle: "アプリ仕様書",
    audienceLabel: "用途",
    audienceEngineer: "正式版",
    audienceNoCode: "やさしい版",
    ...
    sectionOverview: "概要",
    sectionScreenList: "要素一覧",
    sectionScreenDetail: "要素詳細",
    sectionTransitions: "要素遷移",
    tableNum: "#",
    tableName: "要素名",
    tableRole: "役割",
    fieldRole: "役割",
    fieldEntryPoint: "起点要素",
    fieldDescription: "説明",
    fieldDataUsed: "使うデータ",
    fieldFiles: "関連ファイル",
    fieldRelatedScreens: "関連要素",
  ...
  diff: {
    ...
    addedNodesLabel: (n) => `追加された要素 ${n}`,
    removedNodesLabel: (n) => `消えた要素 ${n}`,
    addedEdgesLabel: (n) => `追加されたつながり ${n}`,
    removedEdgesLabel: (n) => `消えたつながり ${n}`,
    ambiguousNote: (n) => `同名の要素 ${n} 件は比較不能`,
    addedBadge: "追加",
    removedBadge: "削除",
    removedSectionTitle: "今回消えた要素(前回分析にはあった)",
    edgeArrow: "→",
    bidiArrow: "↔",
  },
  localLLM: {
...
const EN: Translations = {
  ...
  app: {
    ...
    statusAiMap: (screens, links, costPart, folder) =>
      `AI map: ${screens} elements / ${links} links${costPart} (${folder})`,
    statusDone: "Done",
    statusSelected: (folder, fileCount) =>
  ...
  inspector: {
    panelAriaLabel: "Element detail panel",
  ...
  specDoc: {
    ...
    audienceLabel: "Use",
    audienceEngineer: "Formal",
    audienceNoCode: "Simple",
    ...
    sectionScreenList: "Element list",
    sectionScreenDetail: "Element details",
    sectionTransitions: "Element transitions",
    tableNum: "#",
    tableName: "Element",
    tableRole: "Role",
    fieldRole: "Role",
    ...
    fieldRelatedScreens: "Related elements",
  ...
  notes: {
    ...
    tagClear: "Clear",
    tagHintImportant: "For elements you must double-check before shipping",
    ...
    hint: "Notes for this element. Saved locally on your machine only.",
  },
  qa: {
    sectionTitle: "Ask AI",
    hint: "Ask anything about this element — no jargon needed.",
    placeholder: "e.g. Why is this needed? What breaks if I remove it?",
    sendButton: "Send",
    sending: "AI is thinking…",
    clearButton: "Clear history",
    clearConfirm: "Clear the Q&A history for this element?",
    ...
    suggestionWhat: "What is this element for?",
  ...
  diff: {
    ...
    addedNodesLabel: (n) => `Added elements: ${n}`,
    removedNodesLabel: (n) => `Removed elements: ${n}`,
    addedEdgesLabel: (n) => `Added links: ${n}`,
    removedEdgesLabel: (n) => `Removed links: ${n}`,
    ambiguousNote: (n) => `${n} same-name element(s) can't be compared`,
    addedBadge: "New",
    removedBadge: "Gone",
    removedSectionTitle: "Removed elements (were in the previous analysis)",
    edgeArrow: "→",
    bidiArrow: "↔",
  },
  localLLM: {
